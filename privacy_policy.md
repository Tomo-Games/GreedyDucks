...
This privacy policy applies to the Greedy Ducks app (hereby referred to as "Application") for mobile devices that was created by Tomo Games (hereby referred to as "Service Provider") as a Commercial service. This service is intended for use "AS IS".
...
If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact us through the App Store.
